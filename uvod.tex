...
Fyzické rozhraní MII se skládá ze dvou druhů sběrnic a to datové \ref[MIIdat] a menežovací \ref[MDIOs].
...
Struktura {\em net\_device } je struktura popisující síťové rozhraní.
...
Ta inicializuje tento ovladač do standardního stavu na zákaldě funkce usb\_probe(), která na základě ID produktu a výrobce vybere správný ovladač v našem případě je to ax88772b\_info, která je instancí stuktury driver\_info.
