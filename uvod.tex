...
*net\_device -- reference na síťové zařízení \ref[NETDEV].
...
*net\_device -- popis síťových rozhraní.
\enditems
...
Na obrázku níže můžeme vidět uml diagram důležitých struktur v subsystému DSA \ref[umlDSA].
Na tomto obrázku jsou zvírazněny struktury {\em mii\_bus} a {\em net\_device}.
Tyto struktury bylo potřeba v dalším řešení předat.
...
Na obrázku níže  můžeme vidět uml diagram důležitých struktur v ovladači AX88772b \ref[ASIXdri].
...
Tato část obslužné rutiny též vyplní strukturu {\em asix\_common\_private}, které ve verzi kompatibilní s jadrem verze 3.17 vypadala následovňě:
...
Ve verzi linuxového jádra 3.19 subsystém DSA nevyžaduje strukturu {\em mii\_bus} a byl odstraněn a je nahrazena  strukturou {\em platform\_device}, aby se vyhnulo většině změn v subsystému DSA dle připomýnky v mailing listu \ref[ML].
